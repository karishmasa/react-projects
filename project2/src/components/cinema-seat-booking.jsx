...
//only change if the 3 mentioned changes
...
const getSeatClassName = (seat) => {
    return `w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 m-1 rounded-t-lg border-2 cursor-pointer 
    transition-all duration-200 flex items-center justify-center text-xs sm:text-sm 
    font-bold bg-blue border-blue-300 text-blue-800 `;
...
{seatRow.slice(startIndex,endIndex).map((seat,index)=> {
  ...
  return (
    <div className = "w-full min-h-screen bg-gray-50 p-4">
        ...
        {/*screen*/}
        <div className="mb-8">
            <div className="w-full h-4 bg-gradient-to-r from-green-300 via-gray-400 to-gray-300 rounded-2xl mb-2 shadow-inner"></div>
